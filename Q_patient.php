...
echo $db->insert(['user_id','qstn_txt','spclty_id','qstn_date'],[$_SESSION['loginid'],"'{$_POST['question']}'",$_POST['specialization'],'now()']);
echo "done";
?>
...
<div class="col-md-6">
                                 ...
                                 <aside align="right">
                                        <button type="submit" class="btn btn-info" align="center" name="ask">ASK</button></aside>
